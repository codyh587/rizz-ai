...
function MainText() {
    return (
        <h1 className="bg-[radial-gradient(138.06%_1036.51%_at_95.25%_-2.54%,_#7ED4FD_14.06%,#709DF7_51.02%,#4D78EF_79.09%)] bg-clip-text text-5xl leading-[1.2] tracking-tighter text-transparent sm:text-center sm:text-[4rem] sm:leading-[4.75rem] lg:text-left">
            Make your rizz incredible, without the embarrassing help of friends.
        </h1>
    );
}
...
function GitHubIcon() {
    return (
        <div className="ml-2 w-5 h-5 mt-0.5">
            <svg
                viewBox="0 0 15 15"
                fill="none"
...
function Buttons() {
    return (
        <div className="mt-12 hidden lg:flex">
            <a
                href="#player"
                className="rounded-full bg-sky-300 py-2 px-6 font-semibold text-slate-900 hover:bg-sky-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-900"
            >
                Get Started
            </a>
            <a
                href="https://github.com/codyh587/rizz-ai"
                target="_blank"
