...
export default {
    ...
    ELEVENLABS_VOICE_ID: 'MxNv8Vy5qBqQuzYVmtg0',
    // SHORTEN AI RESPONSE TO SAVE ON ELEVENLABS CREDITS
    DEBUG_SHORTEN_ELEVENLABS_RESPONSE: false,
    DEBUG_SHORTEN_ELEVENLABS_LENGTH_TO: 0,
    DEBUG_LOG_RESPONDER_OUTPUT: true,
    DEBUG_ABANDON_REQUEST_STRINGS_SHORTER_THAN: 3
};
